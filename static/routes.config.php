...
return [
	...
	'/admin' => [
		...
		'/takedown[/{action}[/{id:\d+}]]' => [Module\Admin\Takedown::class,  [R::GET, R::POST]], // UDP: takedown requests
	],
	...
	'/udp/media'     => [
		...
		'/album'        => [Module\Udp\Media\AlbumUpdate::class,    [R::POST]],       // UDP: assign/rename album
		'/manager'      => [Module\Udp\Media\Manager::class,        [R::GET]],        // UDP: full media management page
	],
