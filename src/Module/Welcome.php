...
class Welcome extends BaseModule
{
	protected function content(array $request = []): string
	{
		...
		return Renderer::replaceMacros($tpl, [
			...
			'$circles'             => DI::l10n()->t('Lists'),
			'$circle_contact_link' => DI::l10n()->t('Add Your Contacts To a List'),
			'$circle_contact_txt'  => DI::l10n()->t('Once you have made some friends, organize them into lists from the sidebar of your Contacts page and then you can filter your Network page to any list.'),
