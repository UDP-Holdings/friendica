...
class Create extends BaseModule
{
	...
	private function pickCategory(array $request): string
	{
		...
		return Renderer::replaceMacros($tpl, [
			...
			'$category_copyright'  => ['category', $this->t('Copyright / DMCA')         , Report::CATEGORY_COPYRIGHT , $this->t('This post reproduces copyrighted material without permission. The admin will review the content and may remove it under the DMCA safe harbour process.'), $request['category'] == Report::CATEGORY_COPYRIGHT],
