...
class Site extends BaseAdmin
{
	...
	protected function content(array $request = []): string
	{
		...
		return Renderer::replaceMacros($t, [
			...
			'$newuser_private'                 => ['newuser_private', DI::l10n()->t('Private posts by default for new users'), DI::config()->get('system', 'newuser_private'), DI::l10n()->t('Set default post permissions for all new members to the default privacy list rather than public.')],
			...
			'$compute_circle_counts'    => ['compute_circle_counts', DI::l10n()->t('Generate counts per contact list when calculating network count'), DI::config()->get('system', 'compute_circle_counts'), DI::l10n()->t('On systems with users that heavily use contact lists the query can be very expensive.')],
